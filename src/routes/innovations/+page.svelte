...
<svelte:head>
	<title>Software on the Market - Innovation Portal</title>
</svelte:head>

<div class="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 py-8">
	<!-- Header -->
	<div class="mb-8">
		<h1 class="text-3xl font-bold text-text-primary mb-2">Software on the Market</h1>
		<p class="text-text-secondary">Explore all discovered tools and solutions and find your next project</p>
	</div>
